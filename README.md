...
* Though Batch GD is computationally slow its path actually stops at the minimum, while both Stochastic GD and Mini-batch GD bounce but would also reach the minimum if you used a good learning schedule. However, don’t forget that Batch
<p align='center'>
